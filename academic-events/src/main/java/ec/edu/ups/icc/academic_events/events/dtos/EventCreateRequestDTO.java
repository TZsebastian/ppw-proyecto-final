...
public record EventCreateRequestDTO(
        ...
        @Future(message = "El inicio de inscripciones debe estar en el futuro")
        LocalDateTime registrationStartAt,

        @NotNull(message = "El fin de inscripciones es obligatorio")
        @Future(message = "El fin de inscripciones debe estar en el futuro")
        ...
        @Pattern(
                ...
                message = "Al crear un evento, el estado debe ser DRAFT o PUBLISHED"
        )
        String status
) {
}